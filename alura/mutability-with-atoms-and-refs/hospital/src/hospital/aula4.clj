...
(defn simula-um-dia-em-paralelo-com-mapv
  "Simulacao utilizando um mapv para forcar quase que imperativamente a execucao do que era lazy"
  []
...
(defn simula-um-dia-em-paralelo-com-doseq
  ...
  (let [hospital (atom (h.model/novo-hospital))
    ...
    (doseq [pessoa pessoas] (starta-thread-de-chegada hospital pessoa))
...
(defn simula-um-dia-em-paralelo-com-dotimes
  ...
  (let [hospital (atom (h.model/novo-hospital))]
    ...
    (dotimes [pessoa 6] (starta-thread-de-chegada hospital pessoa))
