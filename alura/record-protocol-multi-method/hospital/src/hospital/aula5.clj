...
(let [particular {:id 15 :nome "Yan" :nascimento "02/04/1998" :situacao :urgente}
      plano { :id 15 :nome "Yan" :nascimento "02/04/1998" :situacao :urgente :plano [:raio-x :ultrassom]}]
...
(let [particular {:id 15 :nome "Yan" :nascimento "02/04/1998" :situacao :normal}
      plano {:id 15 :nome "Yan" :nascimento "02/04/1998" :situacao :normal :plano [:raio-x :ultrassom]}]
  (pprint (deve-assinar-pre-autorizacao? {:paciente particular :valor 1000 :procedimento :coleta-de-sangue}))
  (pprint (deve-assinar-pre-autorizacao? {:paciente plano :valor 1000 :procedimento :coleta-de-sangue})))
