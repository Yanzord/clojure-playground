...
(defn cria-dados-de-exemplo! [conn]
  ...
  (db.produto/adiciona-ou-altera! conn [computador celular-caro celular-barato xadrez jogo] "255.255.255.0")

  (db.categoria/atribui! conn [computador celular-caro celular-barato jogo] eletronicos)
