...
; so ilustrativos para a aula
;(s/validate PacienteID "Yan")
;(s/validate PacienteID 15)
;(s/validate Departamento (conj fila-vazia "Yan" "Brenda"))
;(s/validate Hospital {:espera (conj fila-vazia "Yan" "Brenda")})
