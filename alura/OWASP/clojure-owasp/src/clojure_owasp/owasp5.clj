(ns clojure-owasp.owasp5)

(def lyrics {:geni-e-o-zeppelin "resources/geni-e-o-zeppelin"})
...
(println (get-lyric "geni-e-o-zeppelin"))
...
; nao estou usando keywords pois eh uma simulacao de banco
...
;; solucao horrivel ter todos os params no mesmo lugar
